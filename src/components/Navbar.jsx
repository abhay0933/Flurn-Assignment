    ...
    <>
      <Box
        ...
        <Flex h={16} alignItems={'center'} justifyContent={'space-between'}>
          <Box display={{base:"none",md:"block", lg:"block",xl:"block","2xl":"block"}}><img style={{width: '100px'}} src='https://i.pinimg.com/originals/34/c1/e5/34c1e5d371d64a581b1902ec5c4509f4.png'/></Box>
          <Box
            display="flex"
